-- 단일 행 서브쿼리
-- 서브쿼리의 조회 결과가 0건 또는 1건인 서브쿼리

-- 부서코드가 1000004번인 부서의 사원정보 조회
SELECT
    emp_no
    , emp_nm
    , dept_cd
...
-- 2025.05.25에 받은 급여액수가 2025.05.25 전체 평균 급여보다 높은 사원 정보
-- (사번, 이름, 급여지급일, 받은 급여액수) 조회
...
? 한국데이터베이스진흥원에서 발급한 자격증을 가지고 있는 사원의 사원번호, 사원이름과
? 해당 사원의 한국데이터베이스진흥원에서 발급한 자격증 개수를 조회
